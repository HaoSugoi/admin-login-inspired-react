...
const EmployeeActivitiesStatisticsSection = ({ statistics = {} }) => {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      value: formatNumber(statistics.activeStaff),
      icon: Users,
    ...
    },
    {
      ...
      value: formatNumber(statistics.thisWeekActivities),
      icon: Clock,
    ...
    },
    {
      ...
      value: formatNumber(statistics.thisMonthActivities),
      icon: CheckCircle,
      color: "text-green-600",
      bgColor: "bg-green-50",
    },
    {
      ...
      value: formatNumber(statistics.recentActivities),
      icon: AlertCircle,
      color: "text-red-600",
      bgColor: "bg-red-50",
    },
